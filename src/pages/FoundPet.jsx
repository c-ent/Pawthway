...
const FoundPet = () => {
  ...
  const dog = {
    ...
    reward:'$100',
    message:'Rorie is a very friendly dog. He is very playful and loves to play fetch. He is very friendly with other dogs and people.'
  };
          ...
          <div className='flex pb-7'>
            <div className='w-1/2 space-y-3'>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 31 23" fill="none">
                <path d="M1 11.5C1 11.5 6.27273 1 15.5 1C24.7273 1 30 11.5 30 11.5C30 11.5 24.7273 22 15.5 22C6.27273 22 1 11.5 1 11.5Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M16 16C18.2091 16 20 14.2091 20 12C20 9.79086 18.2091 8 16 8C13.7909 8 12 9.79086 12 12C12 14.2091 13.7909 16 16 16Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
                {dog.color}
              </p>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 27 27" fill="none">
                <path d="M13.5 24.75C19.7132 24.75 24.75 19.7132 24.75 13.5C24.75 7.2868 19.7132 2.25 13.5 2.25C7.2868 2.25 2.25 7.2868 2.25 13.5C2.25 19.7132 7.2868 24.75 13.5 24.75Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13.5 6.75V13.5L18 15.75" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
                {dog.age}
              </p>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                <path d="M12.1553 22.2168C17.6781 22.2168 22.1553 17.7396 22.1553 12.2168C22.1553 6.69395 17.6781 2.2168 12.1553 2.2168C6.63243 2.2168 2.15527 6.69395 2.15527 12.2168C2.15527 17.7396 6.63243 22.2168 12.1553 22.2168Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.1553 15.2168C13.8121 15.2168 15.1553 13.8737 15.1553 12.2168C15.1553 10.5599 13.8121 9.2168 12.1553 9.2168C10.4984 9.2168 9.15527 10.5599 9.15527 12.2168C9.15527 13.8737 10.4984 15.2168 12.1553 15.2168Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
                {dog.size}
              </p>
