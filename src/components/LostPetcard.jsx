...
const LostPetcard = ({ pet }) => {
  ...
  <div className="rounded-md p-4 bg-[#F5F5F5] space-y-2 text-sm group  hover:bg-[#C1C1C1]">
      ...
      <img loading="lazy" src={pet.imageURL} alt={pet.name} className="w-full h-64 object-cover" />
    ...
    <div className='flex justify-between space-x-3'>
      <button  onClick={showForm} className="flex  items-center bg-purple-700 text-white px-3  rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200">
